...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="section-padding bg-gradient-to-b from-dark-blue to-[#131c30]">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="animate-on-scroll glassmorphism rounded-xl p-8 transition-all duration-300 hover:transform hover:translate-y-[-10px] hover:shadow-lg hover:shadow-electric-blue/10"
            >
